...
def test_game_logic():
    ...
    game = Game(1, 10)  # Small range for easier testing
    ...
    for i, guess_history in enumerate(game.guesses, 1):
        print(f"   {i}. Guess: {guess_history.guess}, Result: {guess_history.result}")
...
def show_api_usage():
    ...
    print("\n=== API Usage Examples ===")
    print("Once you have FastAPI installed, you can start the server with:")
...
def show_installation_instructions():
    ...
    print("To run the API server, install the dependencies:")
